...
import time
import sys
sys.path.append(os.path.join(os.path.dirname(os.path.realpath(__file__)), 'lib-python/pyserial-3.0.1/'))
sys.path.append(os.path.join(os.path.dirname(os.path.realpath(__file__)), 'lib-python/xmodem-0.4.4/'))
sys.path.append(os.path.join(os.path.dirname(os.path.realpath(__file__)), 'lib-python/pexpect-4.0.1/'))
sys.path.append(os.path.join(os.path.dirname(os.path.realpath(__file__)), 'lib-python/ptyprocess-0.5.1/'))
